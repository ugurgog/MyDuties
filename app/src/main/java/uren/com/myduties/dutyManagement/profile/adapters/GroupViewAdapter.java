...
public class GroupViewAdapter extends RecyclerView.Adapter<GroupViewAdapter.GroupViewListHolder> implements Filterable {
    ...
    public GroupViewAdapter(Context context, ReturnCallback returnCallback,
    ...
    @Override
    public GroupViewAdapter.GroupViewListHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        view = layoutInflater.inflate(R.layout.group_vert_list_item, parent, false);
        GroupViewAdapter.GroupViewListHolder holder = new GroupViewAdapter.GroupViewListHolder(view);
        return holder;
    }
    ...
    class GroupViewListHolder extends RecyclerView.ViewHolder {
        ...
        public GroupViewListHolder(final View itemView) {
            super(itemView);
        ...
        private void startViewGroupDetailFragment() {
            ...
            GroupDBHelper.getGroup(group.getGroupid(), new CompleteCallback() {
                ...
                public void onComplete(Object object) {
                    fragmentNavigation.pushFragment(new ViewGroupDetailFragment((Group) object, new RecyclerViewAdapterCallback() {
                        @Override
        ...
        public void exitFromGroup(final String userid) {
            ...
            GroupDBHelper.exitUserFromGroup(userid, group.getGroupid(), new CompleteCallback() {
                ...
                public void onComplete(Object object) {
                    ...
                    changeGroupAdmin();
                    accountholderUser.getGroupIdList().remove(group.getGroupid());
                }
    ...
    @Override
    public void onBindViewHolder(GroupViewAdapter.GroupViewListHolder holder, int position) {
